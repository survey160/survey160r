...
- **NA-safe idioms.** Filter with `!((n_completed > 0 | n_web_complete > 0) %in% TRUE)`, never `!(n_completed > 0 | n_web_complete > 0)` -- the latter silently drops all-`NA` blank-phone rows.
