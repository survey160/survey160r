...
#'     campaign exports and to \code{\link{disposition_pull}} /
#'     \code{\link{opt_out_pull}} the disposition projection and opt-out list
#'     (when they must download; a cache hit needs no auth).
